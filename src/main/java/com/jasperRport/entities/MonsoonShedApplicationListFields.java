...
public class MonsoonShedApplicationListFields {
	...
	public String toString() {
		return "MonsoonShedApplicationListFields [application_no=" + application_no + ", update_timestamp="
				+ update_timestamp + ", tenancy_id=" + tenancy_id + ", plot_no=" + plot_no + ", estate=" + estate
				+ ", location=" + location + ", form_status=" + form_status + "]";
	}
}
