...
public class BreachRegularizationApplicationListFields {
	...
	public String toString() {
		return "BreachRegularizationApplicationListFields [application_no=" + application_no + ", update_timestamp="
				+ update_timestamp + ", tenancy_id=" + tenancy_id + ", plot_no=" + plot_no + ", form_status="
				+ form_status + "]";
	}
}
